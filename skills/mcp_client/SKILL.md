...
This skill is located at: `skills/mcp_client/`

**Script path:** `skills/mcp_client/scripts/mcp_client.py`
...
4. `config/mcp.json` (Project config)

**Your config file:** `config/mcp.json`
...
All commands use the script at `skills/mcp_client/scripts/mcp_client.py`:

```bash
# List configured servers
python skills/mcp_client/scripts/mcp_client.py servers

# List tools from a server
python skills/mcp_client/scripts/mcp_client.py tools <server_name>

# Call a tool
python skills/mcp_client/scripts/mcp_client.py call <server> <tool> '{"arg": "value"}'
```
...
# 2. List Zapier tools
python skills/mcp_client/scripts/mcp_client.py tools zapier

# 3. Call a Zapier tool
python skills/mcp_client/scripts/mcp_client.py call zapier <tool_name> '{"param": "value"}'
```
...
```bash
# 1. List tools
python skills/mcp_client/scripts/mcp_client.py tools sequential-thinking

# 2. Use sequential thinking
python skills/mcp_client/scripts/mcp_client.py call sequential-thinking sequentialthinking '{"thought": "Breaking down the problem...", "thoughtNumber": 1, "totalThoughts": 5, "nextThoughtNeeded": true}'
```

## Config Format

Config file format (`config/mcp.json`):
